(function(root, factory) {
	...
	echarts.registerMap('countries/ye/ye-all', {
		...
		},
		{
			"type": "Feature",
			"properties": {
				"name": "Sanʿaʾ Governorate"
			},
			
			"geometry": {
				"type": "Polygon",
				"coordinates": ["@@zdDpspB¼fLf¸^ä²|V[^nUbdKtxhnAJLnd|Sâtt¶ØA^t@Â¸Cº@p^_DŮ}M®ıpĝH§x³vi[J¥ģ¯ėkOybo[¬JØJ¹EVgÂQtN^B¢KŐÁŘ»yƍ»ÏoSCõeG«ÆJQÊEâkR£KõuÕgniruULĽAgÓïGaKw«Ua}]·Z§KI_hJ_¢i~pkeåzq~", "@@\\ÛBViVzgÄThn{OzUö~®IXjAR~¨^ZOkmwS}Ayay¿s"],
				"encodeOffsets": [
					[44551, 15411],
					[45180, 15831]
				]
