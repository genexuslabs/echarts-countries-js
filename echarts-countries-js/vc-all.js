(function(root, factory) {
	...
	echarts.registerMap('countries/vc/vc-all', {
		...
		"features": [{
			...
			"geometry": {
				"type": "Polygon",
				"coordinates": ["@@NJEh\\lbHGrNJ@PIJBRGRDbGVRAHTMNDVIPf@HIjKEMRiP[DoDWGaFaCGFcQOOyKOGWCaZIRKFQPKV"],
				"encodeOffsets": [
					[-62674, 13528]
				]
			}
		...
		},
		{
			...
			"geometry": {
				"type": "Polygon",
				"coordinates": ["@@PXhNFJCZPNNdLJRvVHRRVDJOCUNMGSQBHUCaHQAQJI@OMIHqaGQNK@SKaCWRmV"],
				"encodeOffsets": [
					[-62733, 13594]
				]
			}
