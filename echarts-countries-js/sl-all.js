(function(root, factory) {
	...
	echarts.registerMap('countries/sl/sl-all', {
		...
		"features": [{
			...
			"geometry": {
				"type": "Polygon",
				"coordinates": ["@@bRx@rY¾\\a~phB@ÄOTHWĺpf¾f dV¾Rz\\zUtZ®wxTGdu\\A{~Z\\KÂZb\\_hNt´fzaQ­bÍE]d£EwRhtGmmu£UeDmeomOsËK¡Pe\\uhJÆgl{x\\Zv \\@fkLKaN_]agrÅ·Ío`W_APWoaWy©{OBɟKgcU]yKcq[eyDakSq{m_TýÙi¡ÇPz}L«[´WnvhJvOxuzE¦×ã[{[QVfÒ¡¢ªjDNgPL|^lEl¢YU\\D lrTÎ¨hU¢AÌe@~rcxY¤UZ©b@jevNeTq"],
				"encodeOffsets": [
					[-11880, 8701]
				]
			}
